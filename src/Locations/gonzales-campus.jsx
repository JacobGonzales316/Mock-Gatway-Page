...
export default function GonzalesCampus() {
    return (
        <div>
            <div class="heading">
            <img src='https://travelthesouthbloggers.com/wp-content/uploads/2021/05/Gonzales-Texas-1024x678.jpg'></img>
            </div>
            <br />
            <br />
            <div class='grid-container'>
                <div>
                    <InfoBanner address="Gonzales, TX"
                        times="9:30AM"
                        phoneNumber="210.478.6341 
                        210.852.2081 (NW Office)"
                        campusPastor="Jacob Pena" />
                </div>
                <div class="InfoTile">
