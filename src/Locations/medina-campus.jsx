...
export default function MedinaCampus() {
    return (
        <div>
            <div class="heading">
            <img src='https://texashillcountry.com/wp-content/uploads/Salatico2010-Medina2.jpg'></img>
            </div>
            <br />
            <br />
            <div class='grid-container'>
                <div>
                    <InfoBanner address="Natalia Junior High School
501 8th St.,
Natalia, TX 78059"
                        times="10:45AM"
                        phoneNumber="210.852.2081 (Central Office)"
                        campusPastor="Brandon Smith" />
                </div>
                <div class="InfoTile">
