...
export default function WSCampus() {
    return (
        <div>
            <div class="heading">
            <img src='https://www.visitsanantonio.com/wp-content/uploads/2018/10/ban-2.jpg'></img>
            </div>
            <br />
            <br />
            <div class='grid-container'>
                <div>
                    <InfoBanner address="AGORA Ministries
1103 Merida St
San Antonio, TX 78207"
                        times="6:30PM"
                        phoneNumber="210.852.2081 (Central Office)"
                        campusPastor="Mark Pena" />
                </div>
                <div class="InfoTile">
